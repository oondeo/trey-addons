...
class TestImportTemplateUser(TransactionCase):
        ...
        wizard = self.env["import.file"].create(
            {
                "template_id": self.env.ref(
                    "import_template_user.template_user"
                ).id,
                "file": file,
    ...
    def test_import_create_required_fields(self):
        ...
        self.assertIn(
            _("3: The 'name' field is required."), wizard.line_ids[1].name
        )
        self.assertIn(
            _("3: The 'login' field is required."), wizard.line_ids[2].name
        )
        self.assertIn(
            _("5: The 'name' field is required."), wizard.line_ids[3].name
        )
        self.assertIn(
            _(
        ...
        self.assertIn(
            _("6: The 'login' field is required."), wizard.line_ids[5].name
        )
    ...
    def test_import_create_wrong_values(self):
        ...
        self.assertIn(
            _("4: The 'login' field is required."), wizard.line_ids[1].name
        )
        self.assertIn(
            _("5: The 'name' field is required."), wizard.line_ids[2].name
        )
        user_1 = self.env["res.users"].search(
            [
                ("name", "=", "User partner 1"),
