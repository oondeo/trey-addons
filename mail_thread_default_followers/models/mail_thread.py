...
class MailThread(models.AbstractModel):
    ...
    def _custom_mail_follower_options(
        self, res, followers_setting, email_from
    ):
        ...
        mails = (
            email_from
            and re.findall(r"[\w.+-]+@[\w-]+\.[\w.-]+", email_from)
            or []
        )
        for mail in mails:
        ...
        for record in res:
            if (
                not mails
                and record.create_uid
                and record.create_uid.partner_id
            ):
            ...
            elif followers_setting == "owner_partner" and record.get(
                "partner_id"
            ):
