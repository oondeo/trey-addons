...
class CustomerPortal(CustomerPortal):
    ...
    @http.route(
        ["/my/agreements/accept/all"], type="http", auth="user", website=True
    )
    ...
    @http.route(
        ["/my/agreements/accept/<int:agreement_id>"],
        type="http",
        auth="user",
        website=True,
    )
    ...
    @http.route(
        ["/my/agreements/download/<int:agreement_id>"],
        type="http",
        auth="user",
        website=True,
    )
    def portal_my_agreements_download(
        ...
        pdf = custom and custom or document
