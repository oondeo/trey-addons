...
class SaleOrderLine(models.Model):
    ...
    def _compute_returnable_date(self):
        for line in self:
            ...
            line.returnable_date = (
                ...
                + relativedelta(days=line.product_id.returnable_days)
            )
    ...
    def _compute_amount(self):
        ...
        self.update(
            {
                "price_tax": qty and tax_amount or 0.0,
    ...
    @api.depends(
        ...
        "qty_to_invoice",
        "qty_invoiced",
        "qty_changed_invoiced",
        "qty_returned_invoiced",
        "qty_change",
        "qty_changed_to_invoice",
    )
    def _compute_invoice_status(self):
        ...
        def is_invoiced(line):
            return (
                ...
                and compare(line.qty_returned_invoiced, line.product_uom_qty)
                >= 0
            )
    ...
    def _onchange_qty_change(self):
        if self.qty_change < 0:
            ...
            raise UserError(
                _(
                    "You can not change more units of returned, at most you "
                    "can return %s"
                )
