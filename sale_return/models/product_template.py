...
class ProductTemplate(models.Model):
    ...
    is_returnable = fields.Boolean(default=True, string="Is returnable")
    product_returnable_days = fields.Integer(string="Product returnable days")
    returnable_days = fields.Integer(
        string="Returnable days", compute="_compute_returnable_days"
    )
