...
class TestSaleReturnStates(common.TransactionCase):
    ...
    def create_sale_order(
        self, partner, warehouse, pricelist, product, qty, is_return, ttype
    ):
    ...
    def test_sale_return_multiple_tipology(self):
        ...
        self.assertEquals(
            picking_repaired_to_customer.picking_type_id, self.out_picking_type
        )
