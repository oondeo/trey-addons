...
class WizardChangeSubvention(models.TransientModel):
    ...
    def action_to_step_2(self):
        ...
        if self.subvention_percent == 0.00:
            raise exceptions.Warning(_("Please input % distinct to 0,00"))
        ...
        for invoice_line in invoice_lines:
            if (
                ...
                and invoice_line.invoice_id.state not in ("paid", "open")
            ):
                continue
    ...
    def line_get_convert(
        ...
        if move_type == "credit":
            ...
            subvention_line = {
                ...
                "debit": amount,
                "credit": 0.00,
                "account_id": line.invoice_subvention_id.account_id.id,
            }
        if move_type == "debit":
            customer_line = {
                "partner_id": self.partner_id.id,
