...
class TestEde(TransactionCase):
    def setUp(self):
        ...
        self.company.write(
            {
                ...
                "ede_real_wsdl": "https://webservices.ede.de:9443/ibis/ws/WS_EXT_ELC?wsdl",
                ...
                "ede_runtime": "real",
                "ede_picking_type_id": self.env.ref(
        ...
        self.route_ede_company = self.route_ede_customer.copy(
            {
                "name": "Ede Company",
                "sale_selectable": True,
                "is_ede_company": True,
    ...
    def test_ede_workflow(self):
        ...
        self.assertTrue(
            so.order_line[0].is_simulator,
            msg="Sale: Order Line Not Is Simulator",
        )
        self.assertEquals(
            so.order_line[0].state, "sale", msg="Sale: Line State confirm ok"
        )
        ...
        self.assertEqual(
            po.picking_count, 1, 'Purchase: one picking should be created"'
        )
