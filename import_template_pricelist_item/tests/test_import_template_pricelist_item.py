...
class TestImportTemplateSupplierInfo(TransactionCase):
    def setUp(self):
        ...
        self.brand_01 = self.env["product.brand"].create({"name": "Samsung"})
    ...
    def test_import_create_with_cumulative_discounts_ok(self):
        ...
        wizard = self.env["import.file"].create(
            {
                "template_id": self.env.ref(
                    "import_template_pricelist_item.template_pricelist_item"
                ).id,
                "file": file,
        ...
        self.assertEquals(
            pricelist_items1_2.cumulative_discount_ids.name, "By early payment"
        )
        pricelists_2 = self.env["product.pricelist.purchase"].search(
            [
                ("name", "=", "Condition pricelist test 2"),
    ...
    def test_import_create_applied_on_category_error(self):
        ...
        self.assertIn(
            _("5: The 'categ_id' field is required."), wizard.line_ids[0].name
        )
        self.assertIn(
            _("6: Category New categ not found."), wizard.line_ids[1].name
        )
        self.assertIn(
            _("6: The 'categ_id' field is required."), wizard.line_ids[2].name
        )
        pricelists_1 = self.env["product.pricelist.purchase"].search(
            [
                ("name", "=", "Condition pricelist test 1"),
    ...
    def test_import_create_applied_on_product_tmpl_error(self):
        ...
        self.assertEquals(wizard.total_error, 3)
        self.assertIn(
            _("5: The 'product_tmpl_id' field is required."),
            wizard.line_ids[0].name,
        )
        self.assertIn(
            _("6: Product Template NEWPROD not found."),
            wizard.line_ids[1].name,
        )
        self.assertIn(
            _("6: The 'product_tmpl_id' field is required."),
    ...
    def test_import_create_applied_on_product_error(self):
        ...
        self.assertEquals(wizard.total_error, 3)
        self.assertIn(
            _("5: The 'product_id' field is required."),
            wizard.line_ids[0].name,
        )
        self.assertIn(
            _("6: Product NEWPROD not found."), wizard.line_ids[1].name
        )
        self.assertIn(
    ...
    def test_import_create_applied_on_brand_error(self):
        ...
        self.assertEquals(wizard.total_error, 3)
        self.assertIn(
            _("5: The 'product_brand_id' field is required."),
            wizard.line_ids[0].name,
        )
        self.assertIn(
            _("6: Product Brand New brand not found."), wizard.line_ids[1].name
        )
        self.assertIn(
            _("6: The 'product_brand_id' field is required."),
            wizard.line_ids[2].name,
        )
        pricelists_1 = self.env["product.pricelist.purchase"].search(
            [
    ...
    def test_import_create_applied_on_season_error(self):
        ...
        self.assertEquals(wizard.total_error, 3)
        self.assertIn(
            _("5: The 'product_season_id' field is required."),
            wizard.line_ids[0].name,
        )
        self.assertIn(
        ...
        self.assertIn(
            _("6: The 'product_season_id' field is required."),
            wizard.line_ids[2].name,
        )
        pricelists_1 = self.env["product.pricelist.purchase"].search(
            [
    ...
    def test_import_create_compute_price_fixed_error(self):
        ...
        self.assertIn(
            _("3: The 'fixed_price' field is required."),
            wizard.line_ids[0].name,
        )
        self.assertIn(
            _(
                "5: Option 'False' for 'compute_price' does not exist. You "
    ...
    def test_import_create_compute_price_percentage_error(self):
        ...
        self.assertEquals(wizard.total_error, 2)
        self.assertIn(
            _("3: The 'percent_price' field is required."),
            wizard.line_ids[0].name,
        )
        self.assertIn(
            _(
                "5: Option 'False' for 'compute_price' does not exist. "
                "You must choose a valid value."
            ),
            wizard.line_ids[1].name,
        )
        pricelists_1 = self.env["product.pricelist.purchase"].search(
    ...
    def test_import_create_compute_price_formula_error(self):
        ...
        self.assertIn(
            _("4: The 'base_pricelist_id' field is required."),
            wizard.line_ids[0].name,
        )
        self.assertIn(
            _(
        ...
        self.assertIn(
            _("7: Pricelist New pricelist not found."), wizard.line_ids[2].name
        )
        self.assertIn(
            _("7: The 'base_pricelist_id' field is required."),
