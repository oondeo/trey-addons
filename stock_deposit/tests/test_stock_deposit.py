...
class TestStockDeposit(TransactionCase):
    ...
    def check_and_assign_action_create_deposit(self, deposit_name):
        ...
        domain_rule = [
            (
                "name",
                "=",
                "%s -> %s" % (self.stock_wh.lot_stock_id.name, deposit_name),
            ),
            ("action", "=", "pull"),
    ...
    def test_deposit_sale_last_price_inv_sale_line(self):
        ...
        self.assertEqual(
            self.product1.with_context(location=deposit_loc1.id).qty_available,
            0,
        )
        sale1 = self.create_sale_order(
            partner_deposit1,
            partner_deposit1_ship,
            self.stock_wh,
            self.product1,
            5,
            price_forced=10,
    ...
    def test_deposit_sale_last_price_inv_sale_line_2wizlines(self):
        ...
        self.assertEqual(
            self.product2.with_context(location=deposit_loc1.id).qty_available,
            0,
        )
        sale1 = self.create_sale_order(
            partner_deposit1,
    ...
    def test_deposit_return_stock(self):
        ...
        self.assertEqual(
            len(
                new_sale.invoice_ids.filtered(lambda i: i.type == "out_refund")
            ),
            0,
        )
        self.assertEqual(
    ...
    def test_deposit_inventory(self):
        ...
        self.assertEqual(
            self.product1.with_context(
                location=self.inventory_loc.id
            ).qty_available,
            -1000,
        )
        self.assertEqual(
