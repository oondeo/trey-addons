...
class OrderHistoryCustomerPortal(CustomerPortal):
    ...
    def portal_my_order(self, order_id, access_token=None, **kw):
        ...
        return request.render("sale_return_historical.portal_order", values)
    ...
    def portal_my_order_history_return(
        ...
        template.sudo().with_context(lang=request.env.user.lang).send_mail(
            line.id
        )
        if post:
            ...
            PortalChatter.portal_chatter_post(self, res_model, res_id, message)
