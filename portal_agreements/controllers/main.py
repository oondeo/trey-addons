...
class CustomerPortal(CustomerPortal):
    ...
    def portal_my_agreements(
        ...
        return request.render("portal_agreements.portal_my_agreements", values)
    ...
    def _agreement_get_page_view_values(self, agreement, **kwargs):
        ...
        return self._get_page_view_values(
            agreement, False, values, "my_agreements_history", False, **kwargs
        )

    @http.route(
        ["/my/agreement/<int:agreement_id>"],
        type="http",
        auth="user",
        website=True,
        csrf=False,
