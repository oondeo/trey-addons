...
class ReportPurchaseOrderXlsx(models.AbstractModel):
    ...
    def create_line_workbook(
        ...
        sheet.write(
            ...
            (
                line.sale_order_id
                and line.sale_order_id.team_id.id
                or order
                and order.team_id.id
                or ""
            ),
        )
        sheet.write(
            ...
            (
                line.sale_order_id
                and line.sale_order_id.partner_id.name
                or order
                and order.partner_id.name
                or ""
            ),
        )
        street = (
            line.sale_order_id
            and line.sale_order_id.partner_id.street
            or order
            and order.partner_id.street
            or ""
        )
        street2 = (
            line.sale_order_id
            and line.sale_order_id.partner_id.street2
            or order
            and order.partner_id.street2
            or ""
        )
        ...
        sheet.write(
            ...
            (
                line.sale_order_id
                and line.sale_order_id.partner_id.zip
                or order
                and order.partner_id.zip
                or ""
            ),
        )
        sheet.write(
            ...
            (
                line.sale_order_id
                and line.sale_order_id.partner_id.city
                or order
                and order.partner_id.city
                or ""
            ),
        )
        sheet.write(
            ...
            (
                line.sale_order_id
                and line.sale_order_id.partner_id.phone
                or order
                and order.partner_id.phone
                or ""
            ),
        )
