...
class ProductLabelLine(models.TransientModel):
    ...
    label_id = fields.Many2one(
        comodel_name="product.label", string="Label", required=True
    )
    ...
    product_id = fields.Many2one(related="operation_id.product_id")
    picking_id = fields.Many2one(related="operation_id.picking_id")
