...
class TestSaleMarginPercent(TransactionCase):
    ...
    def test_several_lines_01(self):
        ...
        self.assertEqual(
            sale.order_line[0]
            .filtered(lambda l: l.product_id == self.product_01)
            .margin,
            40,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            sale.order_line[1]
            .filtered(lambda l: l.product_id == self.product_02)
            .margin,
            90,
        )
        self.assertEqual(
        ...
        sale = self.env["sale.order"].create(
            {
                ...
                "order_line": [
                    ...
                    (
                        0,
                        0,
                        {"name": "Note test", "display_type": "line_section"},
                    ),
                ],
            }
        )
    ...
    def test_several_lines_with_section_02(self):
        ...
        self.assertEqual(
            sale.order_line[1].filtered(lambda l: l.product_id is None).margin,
            0,
        )
        self.assertEqual(
            sale.order_line[1]
            .filtered(lambda l: l.product_id is None)
            .margin_percent,
            0,
        )
        self.assertEqual(sale.margin, 40 + 90)
    ...
    def test_several_line_with_price_0(self):
        ...
        self.assertEqual(
            sale.order_line.filtered(
                lambda l: l.product_id == self.product_01
            ).margin,
            20,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            sale.order_line.filtered(
                lambda l: l.product_id == self.product_02
            ).margin,
            -120,
        )
        self.assertEqual(
