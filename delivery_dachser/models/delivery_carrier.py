...
class DeliveryCarrier(models.Model):
    ...
    def _dachser_prepare_create_shipping(self, picking):
        ...
        if not attachments:
            raise exceptions.ValidationError(
                _(
                    "Dachser: you have to create the Dachser file using "
    ...
    def get_dachser_label(self, picking, token):
        ...
        picking.carrier_tracking_ref = res["expediciones"]["ExpedicionWSVO"][
            0
        ]["numUnico"]
        picking.dachser_expedition_code = res["expediciones"][
            "ExpedicionWSVO"
        ][0]["numExpedicion"]
        picking.dachser_shipment_date = res["expediciones"]["ExpedicionWSVO"][
            0
        ]["fechaExpedicion"]
