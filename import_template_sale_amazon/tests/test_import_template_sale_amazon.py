...
class TestImportTemplateSaleAmazon(TransactionCase):
    ...
    def test_import_create_ok(self):
        ...
        wizard = self.env["import.file"].create(
            {
                "template_id": self.env.ref(
                    "import_template_sale_amazon.template_sale_amazon"
                ).id,
                "file": file,
        ...
        sale_amazon = (
            self.env["import.template.sale_amazon"]
        ...
        self.assertEquals(sales_1.partner_id.name, "Esther María - Esther")
        self.assertEquals(
        ...
        self.assertEquals(sales_2.partner_id.name, "José - Antonio Sánchez")
        self.assertEquals(
        ...
        self.assertEquals(sales_2.partner_id.street, "Calle Madrid")
        self.assertEquals(sales_2.partner_id.street2, "33, 1ºB")
        self.assertEquals(sales_2.partner_id.city, "Armilla")
    ...
    def test_import_default_code_empty_create_error(self):
        ...
        self.assertIn(
            "2: Column 'product_id' cannot be empty.", wizard.line_ids[1].name
        )
        partner_1 = self.env["res.partner"].search(
            [
                ("name", "=", "Esther María - Esther"),
        ...
        state = self.env["res.country.state"].search(
            [
                ...
                (
                    "country_id",
                    "=",
                    self.env.ref("import_template.no_country").id,
                ),
            ]
        )
    ...
    def test_import_several_state_id_with_code_00(self):
        fname = self.get_sample("sample_new_several_state_id_with_country.txt")
        file = base64.b64encode(open(fname, "rb").read())
        wizard = self.env["import.file"].create(
            {
                "template_id": self.env.ref(
        ...
        self.assertEquals(sales_2.partner_id.street, "Calle Madrid")
        self.assertEquals(sales_2.partner_id.street2, "33, 1ºB")
        self.assertEquals(sales_2.partner_id.city, "Alhama")
        self.assertEquals(sales_2.partner_id.zip, "29793")
