...
class TestStockPickingReturnSupplier(common.TransactionCase):
    ...
    def test_standard_mtd_purchase(self):
        ...
        self.assertEquals(
            picking_supplier.move_lines[0].name, self.product_dropshipping.name
        )
        self.assertEquals(
    ...
    def test_standard_mtd_multiple_purchase(self):
        ...
        self.assertEquals(move_01.product_id, self.product_dropshipping)
        self.assertEquals(move_02.product_id, self.product_dropshipping_02)
    ...
    def test_standard_mtd_partial_stock(self):
        ...
        self.assertEquals(
            wizard_02.confirm_line_ids[0].product_id, self.product_dropshipping
        )
