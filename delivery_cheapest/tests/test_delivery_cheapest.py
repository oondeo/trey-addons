...
class TestDeliveryCheapest(common.TransactionCase):
    ...
    def test_get_cheapest_delivery_sale_order_multiple_option(self):
        ...
        prices = []
        available_carriers = (
            carriers.available_carriers(self.sale.partner_shipping_id)
            if (self.sale.partner_shipping_id)
            else carriers
        )
    ...
    def test_get_cheapest_delivery_stock_picking_multiple_option(self):
        ...
        prices = []
        available_carriers = (
            carriers.available_carriers(picking.sale_id.partner_shipping_id)
