...
class DeliveryCarrier(models.Model):
    ...
    def _dhl_prepare_create_shipping(self, picking):
        ...
        shipping_weight = (
            ...
            and round(
                picking.weight_uom_id._compute_quantity(
                    picking.shipping_weight,
    ...
    def dhl_tracking_state_update(self, picking):
        ...
        if not self.dhl_username:
            ...
            return
        url = "https://external.dhl.es/cimapi/api/v1/customer/track?id=%s" % (
        ...
        if response.status_code == 400:
            ...
            raise exceptions.UserError(_("DHL exception: %s") % res["Message"])
