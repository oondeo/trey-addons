...
class DeliveryCarrier(models.Model):
    ...
    def tipsa_create_shipping(self, picking):
        ...
        tracking_token = res.text[
            tracking_reference_start + 16 : tracking_reference_end
        ]
        ...
        picking.tipsa_picking_reference = res.text[
            picking_tipsa_start + 18 : picking_tipsa_end
        ]
