...
class TestImportTemplatePartner(TransactionCase):
    ...
    def test_import_create_base_ok(self):
        ...
        wizard = self.env["import.file"].create(
            {
                "template_id": self.env.ref(
                    "import_template_partner.template_partner"
                ).id,
                "file": file,
        ...
        self.assertIn(
            _("3: Contact Customer 1 not found."), wizard.line_ids[0].name
        )
        self.assertIn(
            _("4: Contact Customer 1 not found."), wizard.line_ids[1].name
        )
    ...
    def test_import_create_with_category_id(self):
        ...
        self.assertIn(
            _("5: Partner category (tag) Partner categ 3 not found."),
    ...
    def test_import_create_with_invoice_group_method_id(self):
        ...
        self.assertIn(
            _("5: Sale Invoice Group Method By sale date not found."),
            wizard.line_ids[2].name,
        )
        partners_1 = self.env["res.partner"].search(
            [
    ...
    def test_import_create_with_payment_term_id(self):
        ...
        self.assertIn(
            _("5: Payment Terms Other day not found."), wizard.line_ids[2].name
        )
        self.assertIn(
            _("5: Payment Terms Or another day not found."),
        ...
        self.assertEquals(wizard.total_error, 2)
        self.assertIn(
            _("5: Payment Terms Other day not found."), wizard.line_ids[0].name
        )
        self.assertIn(
            _("5: Payment Terms Or another day not found."),
    ...
    def test_import_create_with_payment_mode_id(self):
        ...
        self.assertIn(
            _("5: Payment Modes Other payment mode customer not found."),
            wizard.line_ids[2].name,
        )
        self.assertIn(
            _("5: Payment Modes Other payment mode supplier not found."),
            wizard.line_ids[3].name,
        )
        partners_1 = self.env["res.partner"].search(
            [
    ...
    def test_import_create_with_product_pricelist(self):
        ...
        self.assertIn(
            _("5: Pricelist Other pricelist not found."),
            wizard.line_ids[2].name,
        )
        self.assertIn(
            _(
    ...
    def test_import_create_with_account_position_id(self):
        ...
        self.assertIn(
            _("5: Fiscal Position Other fiscal position not found."),
            wizard.line_ids[2].name,
        )
        partners_1 = self.env["res.partner"].search(
            [
    ...
    def test_import_create_with_credit_control(self):
        ...
        self.assertIn(
            _("5: Define a reminder policy Other control policy not found."),
            wizard.line_ids[2].name,
        )
        partners_1 = self.env["res.partner"].search(
            [
        ...
        self.assertEquals(
            partners_1.payment_next_action_date.strftime("%Y-%m-%d"),
            "2021-01-01",
        )
        partners_1_1 = self.env["res.partner"].search(
            [
    ...
    def test_import_create_with_commission(self):
        ...
        self.assertIn(
            _("5: Commission in sales Other commission not found."),
            wizard.line_ids[2].name,
        )
        partners_1 = self.env["res.partner"].search(
            [
    ...
    def test_import_create_required_fields(self):
        ...
        self.assertIn(
            _(
                ...
                "must choose a valid value."
            ),
            wizard.line_ids[1].name,
        )
        self.assertIn(
            _("3: The 'company_type' field is required."),
            wizard.line_ids[2].name,
        )
        self.assertIn(
            _("4: Contact Customer 1 not found."), wizard.line_ids[3].name
        )
        self.assertIn(
            _(
        ...
        self.assertIn(
            _("4: The 'name' field is required."), wizard.line_ids[5].name
        )
        self.assertIn(
            _("4: The 'company_type' field is required."),
            wizard.line_ids[6].name,
        )
        self.assertIn(
            _("5: Contact Customer 1 not found."), wizard.line_ids[7].name
        )
        self.assertIn(
            _("6: The 'name' field is required."), wizard.line_ids[8].name
        )
        self.assertIn(
            _(
            ...
            wizard.line_ids[9].name,
        )
        self.assertIn(
            _("7: The 'company_type' field is required."),
        ...
        self.assertIn(
            _("4: The 'name' field is required."), wizard.line_ids[3].name
        )
        self.assertIn(
            _("4: The 'company_type' field is required."),
            wizard.line_ids[4].name,
        ...
        self.assertIn(
            _("6: The 'name' field is required."), wizard.line_ids[5].name
        )
        self.assertIn(
            _(
                "7: Option 'False' for 'company_type' does not exist. You "
    ...
    def test_import_create_wrong_values(self):
        ...
        self.assertIn(
            _("2: The 'company_type' field is required."),
            wizard.line_ids[1].name,
        )
        self.assertIn(
            _(
        ...
        self.assertIn(
            _("3: Contact Customer 1 not found."), wizard.line_ids[3].name
        )
        self.assertIn(
            _(
                "3: Option 'False' for 'company_type' does not exist. You "
    ...
    def test_import_partner_with_agent(self):
        ...
        self.assertEquals(wizard.total_error, 2)
        self.assertIn(
            _("6: Agent with name Agent X not found"), wizard.line_ids[0].name
        )
        self.assertIn(
            _("7: Agents found with same name Agent test 3"),
            wizard.line_ids[1].name,
        )
        wizard.action_import_from_simulation()
        self.assertEquals(wizard.total_rows, 6)
