...
class TestMrpPackageDummy(TestMrpCommon):
    def test_production(self):
        ...
        self.assertEqual(
            quant_obj._get_available_quantity(product, stock_location), 2
        )
        self.assertEqual(
            quant_obj._get_available_quantity(component1, stock_location), 0
        )
        self.assertEqual(
            quant_obj._get_available_quantity(component2, stock_location), 0
        )
    ...
    def test_production_with_lot_and_packaging(self):
        ...
        self.assertEqual(mo.state, "done")
        self.assertEqual(
            quant_obj._get_available_quantity(product, stock_location), 12
        )
        self.assertEqual(
            quant_obj._get_available_quantity(component1, stock_location), 0
        )
